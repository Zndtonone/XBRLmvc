...
{
    /// <summary>
    /// An encapsulation of the XBRL element "link".
    /// </summary>
    public class ExtendedLink : XlinkNode
    {
        /// <summary>
        ...
        //------------------------------------------------------------------------------------
        //------------------------------------------------------------------------------------
        internal ExtendedLink(INode LabelLinkNode) : base(LabelLinkNode)
        {
        ...
        private void ReadChildLabelArcs(INode LabelLinkNode)
        {
            ...
            {
                // This class was copied from the LabelLink class, and "labelArc" was changed to "arc"
                if (CurrentChildNode.LocalName.Equals("arc") == true)

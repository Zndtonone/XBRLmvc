...
namespace JeffFerguson.Gepsio
{
    ...
    public class LabelLink : XlinkNode
    {
        ...
        public static string removePath(string strPath)
        {
        ...
        {
            foreach(var currentLocator in Locators) // RTH GetLocator - Remove path
            {
                var clh = removePath(currentLocator.Href);

                if (clh.Equals(href) == true)

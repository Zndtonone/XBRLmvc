...
namespace JeffFerguson.Gepsio
{
    ...
    public class XbrlFragment
    {
        ...
        private List<string> LocateSubSchemas(string localPath)
        {
            // SDS Return only schemas from subdirectories
            DirectoryInfo directory = new DirectoryInfo(localPath);
            DirectoryInfo[] directories = directory.GetDirectories();

            List<string> subFolders = new List<string>();
            List<string> allSubSchemas = new List<string>();

            /*/ SDS Fyribils burtur fyri at vita um øll subskema eru neyðug

             foreach (DirectoryInfo folder in directories)
             {
                 var allfolders =
                  new DirectoryInfo(localPath + "/" + folder.Name)
                  .EnumerateFiles("*.xsd", SearchOption.AllDirectories)
                  .Select(d => d.FullName).ToList();

                 foreach (var schema in allfolders)
                 {
                     var x = schema.Replace(localPath, ".").Replace("\\", "/");
                     if (x.StartsWith(".")) { x = x.Substring(x.IndexOf("./") + 2); }
                     allSubSchemas.Add(x);
                     Console.WriteLine(x);
                 }
             }
            ...
            allSubSchemas.Add(@"XBRL20171001/boolean-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/concept-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/consistency-assertion.xsd");
            allSubSchemas.Add(@"XBRL20171001/dimension-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/entity-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/existence-assertion.xsd");
            allSubSchemas.Add(@"XBRL20171001/formula.xsd");
            allSubSchemas.Add(@"XBRL20171001/general-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/generic-label.xsd");
            allSubSchemas.Add(@"XBRL20171001/generic-link.xsd");
            allSubSchemas.Add(@"XBRL20171001/generic-message.xsd");
            allSubSchemas.Add(@"XBRL20171001/generic-reference.xsd");
            allSubSchemas.Add(@"XBRL20171001/match-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/nonNumeric-2009-12-16.xsd");
            allSubSchemas.Add(@"XBRL20171001/numeric-2009-12-16.xsd");
            allSubSchemas.Add(@"XBRL20171001/period-filter.xsd");
            //allSubSchemas.Add(@"XBRL20171001/ref -2006-02-27.xsd");
            allSubSchemas.Add(@"XBRL20171001/relative-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/segment-scenario-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/tuple-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/unit-filter.xsd");
            allSubSchemas.Add(@"XBRL20171001/validation-message.xsd");
            allSubSchemas.Add(@"XBRL20171001/validation.xsd");
            ...
            allSubSchemas.Add(@"XBRL20171001/20171001/tch.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/arr/arr.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/dst/dst.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/fsa/fsa.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/gsd/gsd.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/cmn.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/mrv/mrv.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/sob/sob.xsd");
            allSubSchemas.Add(@"XBRL20171001/20171001/tax/tax.xsd");

            return allSubSchemas;
        }

        ///// <summary>
        ///// XBRLviewer - locates all sub schemas
        ///// </summary>
        ...
        /// <summary>
        /// XBRLviewer - this method adds sub schemas
        /// </summary>
        /// <param name="Base"></param>
        /// <param name="newSchema"></param>
        void AddSubSchemas(string Base, XbrlSchema newSchema)
        {
            var runtimePath =  Environment.CurrentDirectory;
            var loadPath = Path.GetDirectoryName(newSchema.LoadPath);
            var schemaVersion = "";
            if (loadPath.StartsWith("http"))
            {
                while(loadPath.IndexOf("\\")>0)
                {
                    loadPath = loadPath.Substring(loadPath.IndexOf("\\")+1);
                }
                schemaVersion = @"\" + loadPath + @"\";
            }
            else
            {
                schemaVersion = @"\" + loadPath.Replace("file:\\", "").Replace(runtimePath, "").Replace("\\", "") + @"\";
            }

            foreach (var schema in LocateSubSchemas(runtimePath + schemaVersion))
                try
                {
        ...
        private void ReadFacts()
        {
            ...
            foreach (INode CurrentChild in this.XbrlRootNode.ChildNodes) // RTH elements in instance
            {

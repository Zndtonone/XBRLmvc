...
namespace JeffFerguson.Gepsio
{
    ...
    public class LinkbaseDocument
    {
        ...
        internal static LinkbaseDocument Create(string containingDocumentUri, string href, XbrlFragment containingFragment)
        {
            ...
            if (firstChildLocalName.Equals("roleRef")) // RTH - Hetta fær bara fatur á øllum fílum við "gla" og "frm" í fílnavninum. Tvs ikki hinar fílurnar.
            {
                return new ExtendedLinkbaseDocument(containingDocumentUri, href, containingFragment);
            }

...
namespace JeffFerguson.Gepsio
{
    ...
    public class XbrlSchema
    {
        ...
        internal XbrlSchema(XbrlFragment ContainingXbrlFragment, string SchemaFilename, string BaseDirectory)
        {
            ...
            try
            {
                if (ReadAndCompile(this.SchemaReferencePath) == false) // RTH Compile
                    return;
            }
        ...
        private void ReadSimpleTypes()
        {
            ...
            //INodeList SimpleTypeNodes = thisSchemaDocument.SelectNodes("//linkbaseRef:linkbaseRef", this.NamespaceManager);

    ...
    public class XbrlSchemaCollection : IEnumerable<XbrlSchema>
    {
        ...
        private static void BuildStandardNamespaceSchemaLocationDictionary()
        {
            StandardNamespaceSchemaLocationDictionary = new Dictionary<string, string>
            {
                ...
                { "http://www.xbrl.org/2008/generic-link.xsd#standard-link-role", "http://www.xbrl.org/2008/generic-link.xsd" },
                { "http://www.xbrl.org/2008/generic-label.xsd#standard-label", "http://www.xbrl.org/2008/generic-label.xsd" },
            };
        }
        ...
        internal void Add(XbrlSchema schemaToAdd) // RTH add
        {
            ...
            //foreach (var currentSchema in SchemaList)  //SDS Refactored 19092020
            //{
            //    if (schemaToAdd.TargetNamespace.Equals(currentSchema.TargetNamespace) != true)
            //        SchemaList.Add(schemaToAdd);
            //}
